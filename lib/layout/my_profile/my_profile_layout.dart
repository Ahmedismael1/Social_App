        ...
        body: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(children: [
              ...
              Text(
                '${SocialCubit.get(context).myPost.length} Posts',
              ...
              Row(
                children: [
                  ...
                  OutlinedButton(
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>EditProfile()));                        // Update the state of the app.
              ...
              ConditionalBuilder(
                condition: SocialCubit.get(context).myPost.length > 0 ,

                builder: (context) => ListView.separated(
                    shrinkWrap: true,
                    physics: NeverScrollableScrollPhysics(),
                    itemBuilder: (context, index) => buildProfilePosts(
                        SocialCubit.get(context).myPost[index],
                        index,
                        context),
                    separatorBuilder: (context, index) => SizedBox(
                      height: 5,
                    ),
                    itemCount: SocialCubit.get(context).myPost.length),
                fallback: (context) =>
